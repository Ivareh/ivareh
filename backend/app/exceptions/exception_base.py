...
class IvarehAPIError(HTTPException):
    """
    Base class for exceptions in the Ivareh API module.
    ...
    def __init__(
        ...
        *,
        ...
        detail: str | None = "Ivareh API service is unavailable",
        ...
        detail = f"Ivareh: status={status_code} : function={function_name} : {detail}"
        super().__init__(
            status_code=status_code,
            detail=detail,
            headers=headers,
